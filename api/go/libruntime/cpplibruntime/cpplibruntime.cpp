...
CErrorInfo CInit(CLibruntimeConfig *config)
{
    ...
    librtCfg.encryptPrivateKeyPasswd = config->encryptPrivateKeyPasswd;
    ...
    librtCfg.runtimePublicKey = config->runtimePublicKeyContext;
    librtCfg.runtimePrivateKey = config->runtimePrivateKeyContext;
    librtCfg.dsPublicKey = config->dsPublicKeyContext;
    librtCfg.encryptRuntimePublicKeyContext = config->encryptRuntimePublicKeyContext;
    librtCfg.encryptRuntimePrivateKeyContext = config->encryptRuntimePrivateKeyContext;
    librtCfg.encryptDsPublicKeyContext = config->encryptDsPublicKeyContext;
