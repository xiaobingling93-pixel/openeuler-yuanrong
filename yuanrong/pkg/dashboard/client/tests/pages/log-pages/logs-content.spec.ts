...
import LogsContent from '@/pages/log-pages/logs-content.vue';

describe('LogsContent', () => {
    const wrapper = mount(LogsContent, {
        global: {
            stubs: {
    ...
    it('renders the main structure correctly', () => {
        expect(wrapper.findComponent(LogContentTemplate).exists()).toBe(true);
    });
})