...
func example() {
	RegisterInitializerFunction(initEntry)
	RegisterPreStopFunction(preStopEntry)
	Register(callEntry)
}

func TestRegister(t *testing.T) {
	convey.Convey(
		"Test Register", t, func() {
			convey.Convey(
				"Register success", func() {
					convey.So(example, convey.ShouldNotPanic)
				},
			)
		},
	)
